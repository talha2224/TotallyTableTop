    ...
    return (
        <div className='flex flex-col w-[100vw] h-[100vh] overflow-y-auto'>
            ...
            <div className='bg-black md:px-[2rem] px-[1rem] flex items-center gap-x-4 py-3 '>
                ...
                <BsFillCaretDownFill className=' text-lightOrange -rotate-90' />
                <span className='text-white'>UK Games Expo</span>
            </div>
            ...
            <div className='md:px-[2rem] px-[1rem] bg-darkBlue h-[86vh] w-[100vw] pt-3 overflow-y-auto'>
                ...
                <div className='flex justify-between items-start sm:items-center flex-wrap w-[100%] sm:flex-row flex-col'>
                    <div className='flex items-center gap-x-4'>
                        ...
                        <h1 className='text-3xl font-bold text-white'>UK Games Expo Accomodation</h1>
                    </div>
                    <Button onClickFunc={() => nav("/new/accomodation")} title={"Add New"} className={`w-[8rem] h-[2.3rem] rounded-md border border-lightOrange text-white sm:mt-0 mt-3`} />
                </div>
                ...
                <div className='mt-6'>
                    {
                        data.map((i) => (
                            <div key={i} className='w-[100%] sm:h-[10rem] bg-[#0d2539] p-3 rounded-md flex justify-between items-start relative sm:flex-row flex-col mt-4'>
                                <div className=''>
                                    <h1 className='text-lg font-semibold text-white'>Hilton Birmingham Metropole</h1>
