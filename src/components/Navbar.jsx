                ...
                type === "verified" ?
                    ...
                    <div className='w-[100%] min-h-[10vh] md:h-[14vh] bg-[#0d2539] px-[1rem] md:px-[2rem] flex justify-between items-center border-b-4 border-lightYellow'>
                        ...
                        <div className='flex gap-x-[1rem] items-center'>
                            <div onClick={() => nav("/home")} className='md:w-[3rem] cursor-pointer w-[2.4rem] md:h-[3rem] h-[2.4rem] rounded-full bg-lightOrange flex justify-center items-center'>
                    ...
                    <div className='w-[100%] h-[10vh] md:h-[14vh] bg-[#0d2539] px-[1rem] md:px-[2rem] flex justify-between items-center border-b-4 border-lightYellow'>
                        ...
                        <div className='flex gap-x-[1rem] items-center'>
                            <div onClick={() => nav("/")} className='md:w-[3rem] cursor-pointer w-[2.4rem] md:h-[3rem] h-[2.4rem] rounded-full bg-lightOrange flex justify-center items-center'>
                                <img src={Logo} alt="" className='h-[2.2rem]' />
                            </div>
